...
@Table(
        name = "technology",
        uniqueConstraints = {
            @UniqueConstraint(name = "uq_technology_slug", columnNames = "slug"),
            @UniqueConstraint(name = "uq_technology_name", columnNames = "name")
        })
public class TechnologyEntity extends AuditedEntity {
